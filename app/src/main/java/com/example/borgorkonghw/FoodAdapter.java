...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final FoodAdapter.ViewHolder viewHolder, final int position) {
        ...
        viewHolder.text.setText(food.getName() + "\n$" + food.getPrice() );
        //this will check if we're on the menu or order screen and
        // prevent the quantity showing on the menu screen, but still show it on the order screen
        if (orderClass) viewHolder.text.setText(viewHolder.text.getText() + "\nx" + food.getQuantity());
